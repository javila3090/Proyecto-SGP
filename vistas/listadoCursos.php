...
<div class="container">
    <div class="page-header">
        <h3 class="title">Cursos registrados</h3>
    </div>
        ...
        <table id="listado" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
                <tr class="ui-widget-header">
                    ...
                    <th style="width:auto;" align="center"><b>Nombre</b></th>
                    <th style="width:20%;" align="center"><b>Duraci&oacute;n</b></th>
                    <th style="width:20%; text-align: center" align="center"><b>Editar</b></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center"><img title="Ver detalles" id="" onclick="enviarDatos(<?php echo $curso -> id; ?>,'../vistas/formEditarCursos.php',6);return false;" src="../images/editar.png" style="cursor: pointer;"></img></td>
